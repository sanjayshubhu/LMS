    ...
    <div class="bg-white shadow-md rounded-lg overflow-hidden">
        <div class="px-6 py-4 border-b border-gray-200 flex items-center justify-between">
            ...
            <div class="flex items-center space-x-2">
                <input type="text" id="searchBookAdmin" placeholder="Search books..."
        ...
        <div class="p-6" id="booksAdminContainer">
            @if ($books->isEmpty())
                            ...
                            @foreach ($books as $book)
                                <tr class="hover:bg-gray-50 transition">
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <input type="text" id="title-input-{{ $book->id }}"
                                            value="{{ $book->title }}" class="border rounded px-2 py-1 w-full hidden">
                                    </td>

                                    {{-- Quantity --}}
                                    <td class="px-6 py-4">
                                        <span id="quantity-display-{{ $book->id }}">{{ $book->quantity }}</span>
                                        <input type="number" id="quantity-input-{{ $book->id }}"
                                            value="{{ $book->quantity }}"
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <input type="text" id="author-input-{{ $book->id }}"
                                            value="{{ $book->author }}" class="border rounded px-2 py-1 w-full hidden">
                                    </td>

                                    {{-- Category --}}
                                    <td class="px-6 py-4">
                                        <span id="category-display-{{ $book->id }}">{{ $book->category }}</span>
                                        <input type="text" id="category-input-{{ $book->id }}"
                                            value="{{ $book->category }}"
                                            class="border rounded px-2 py-1 w-full hidden">
                                    </td>
                                    ...
                                    <td class="px-6 py-4">
                                        ...
                                        <input type="text" id="isbn-input-{{ $book->id }}"
                                            value="{{ $book->isbn }}" class="border rounded px-2 py-1 w-full hidden">
                                    </td>
